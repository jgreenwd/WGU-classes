...
public class LoginController implements Initializable {
    ...
    public void accessButtonPressed(ActionEvent e) throws IOException, SQLException, ClassNotFoundException, NullPointerException {
        boolean validity = false;

        try {
            DBConnection.makeConnection(loginUsername.getText().trim(), loginPassword.getText().trim());
            ...
            if (Query.login(loginUsername.getText().trim(), loginPassword.getText().trim())) {
                ...
                /* =================================================================
                 * (4025.01.08) - H: Pending Appointment Alert
                 *
